...
import net.sf.l2j.mods.util.FakePlayerLog;
...
public final class FakePlayerAiEngine
{
	...
	public static void process(List<FakePlayer> list, int from, int to)
	{
		for (int i = from; i < to; i++)
		{
			...
			if (fp == null || fp.isDestroyed() || !fp.isOnline() || !fp.isVisible())
				continue;
			...
			{
				FakePlayerLog.logOnce(fp, "Unhandled exception during AI tick.", t);
			}
			finally
			{
				ai.doneThinking();
