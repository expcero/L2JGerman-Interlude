...
public final class FakePlayerFactory
{
	...
	public static FakePlayer create(int classId, int x, int y, int z)
	{
		...
		// PLAYER
		// ===============================
		if (Player.create(objectId, pcTemplate, accountName, name, hairStyle, hairColor, face, sex) == null)
			throw new IllegalStateException("Nao foi possivel persistir o FakePlayer " + name + ".");
		...
		fake.store();
		return FakePlayerRestoreEngine.getInstance().activate(fake);
	}
}
