...
public final class L2GameClient extends MMOClient<MMOConnection<L2GameClient>> implements Runnable
{
	...
	public L2GameClient(MMOConnection<L2GameClient> con)
	{
		...
		_autoSaveInDB = (con == null) ? null : ThreadPool.scheduleAtFixedRate(ThreadPool.PoolType.SAVE, "ClientAutoSave", new AutoSaveTask(), 300000L, 900000L);
	}
	...
	protected void onDisconnection()
	{
		...
		try
		{
			ThreadPool.execute("ClientDisconnect", new DisconnectTask());
		}
	...
	public void closeNow()
	{
		...
		synchronized (this)
		{
			...
			_cleanupTask = ThreadPool.schedule("ClientCleanup", new CleanupTask(), 0); // instant scheduled
		}
	}
	...
	private void prepareDetachedOfflineClient()
	{
		setDetached(true);
		_packetQueue.clear();
