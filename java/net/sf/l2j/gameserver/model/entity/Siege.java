...
public class Siege implements Siegable
{
	...
	protected ScheduledFuture<?> _scheduledEndSiegeTask;
	...
	public void startSiege()
	{
		if (!_isInProgress)
		{
			...
			if (_scheduledEndSiegeTask != null)
				_scheduledEndSiegeTask.cancel(false);
			
			_scheduledEndSiegeTask = ThreadPool.schedule(new ScheduleEndSiegeTask(getCastle()), 1000);
