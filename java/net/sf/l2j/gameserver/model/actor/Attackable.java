...
public class Attackable extends L2Npc
{
	...
	/**
	 * Clears references which can keep players, summons or NPCs alive after death/despawn.
	 * This method is intentionally conservative: it doesn't change reward logic and is called
	 * only after the normal death/delete flow has already started.
	 */
	private void clearAttackableReferences()
	{
		_attackByList.clear();
		_aggroList.clear();
		...
		_firstCommandChannelAttacked = null;
		_commandChannelTimer = null;
		setTarget(null);
