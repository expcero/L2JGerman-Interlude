...
public class L2Clan
{
	...
	{
		cleanupExpiredWarPenalty();
		return _warPenaltyExpiryTime;
	}
	
	public void cleanupExpiredWarPenalty()
	{
		if (_warPenaltyExpiryTime.isEmpty())
			return;
		
		final long now = System.currentTimeMillis();
		_warPenaltyExpiryTime.entrySet().removeIf(e -> e.getValue() == null || e.getValue() <= now);
	}
