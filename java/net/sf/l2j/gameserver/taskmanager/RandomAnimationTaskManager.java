...
public final class RandomAnimationTaskManager implements Runnable
{
	...
	{
		if (character == null || character.isDecayed() || character.isDead() || !character.isVisible())
			return;
	...
	/**
	 * Removes a NPC from the random animation task. This is important during decay/delete
	 * because this manager stores the NPC instance as map key.
	 * @param character The NPC to remove.
	 */
	public final void cancel(L2Npc character)
	{
		if (character != null)
